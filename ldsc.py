...
def ldscore(args, log):
    ...
    geno_array = array_obj(array_file, n, array_snps, keep_snps=keep_snps, keep_indivs=keep_indivs, mafMin=args.maf)
...
parser.add_argument(
    "--l2", default=False, action="store_true", help="Estimate l2. Compatible with both jackknife and non-jackknife."
)
...
parser.add_argument("--chunk-size", default=50, type=int, help="Chunk size for LD Score calculation. Use the default.")
parser.add_argument(
    "--pickle",
    default=False,
    action="store_true",
...
parser.add_argument(
    "--yes-really", default=False, action="store_true", help="Yes, I really want to compute whole-chromosome LD Score."
)
parser.add_argument(
    "--invert-anyway",
    default=False,
...
parser.add_argument(
    "--samp-prev", default=None, help="Sample prevalence of binary phenotype (for conversion to liability scale)."
)
parser.add_argument(
    "--pop-prev", default=None, help="Population prevalence of binary phenotype (for conversion to liability scale)."
)
