...
class Test_Gencov_1D(unittest.TestCase):
    ...
    def test_summary(self):
        ...
        gencov = reg.Gencov(
            self.z1, self.z2, self.ld, self.w_ld, self.N1, self.N2, self.M, self.hsq1, self.hsq2, 1.0, 1.0, n_blocks=3
        )
        gencov.summary(["asdf"])
...
class Test_Gencov_2D(unittest.TestCase):
    ...
    def test_eq_hsq(self):
        ...
        gencov = reg.Gencov(
            self.z1, self.z1, self.ld, self.w_ld, self.N1, self.N1, self.M, 0, 0, 0, 0, n_blocks=3, intercept_gencov=1
        )
...
class Test_RG_2D(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.hsq1 = 0.5
        self.hsq2 = 0.6
        self.rg = reg.RG(self.z1, -self.z1, self.ld, self.w_ld, self.N1, self.N1, self.M, 1.0, 1.0, 0, n_blocks=20)
